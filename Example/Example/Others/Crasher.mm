//
// From: https://github.com/kstenerud/KSCrash/blob/master/Source/Common-Examples/Crasher.mm
//
//  Crasher.m
//
...
//    NSLog(@"%d", value);
    ...
    // https://stackoverflow.com/questions/28514145/division-by-zero-in-objectivec
    ...
    __unused NSDecimalNumber *x = [i decimalNumberByDividingBy:o];
}
