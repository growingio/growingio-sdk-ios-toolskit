...
#import "GrowingTKUIMonitorPlugin.h"
...
@interface GrowingTKUIMonitorPlugin ()

@end

@implementation GrowingTKUIMonitorPlugin
...
+ (instancetype)plugin {
    static GrowingTKUIMonitorPlugin *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[GrowingTKUIMonitorPlugin alloc] init];
    });
    return instance;
}
...
- (NSString *)pluginName {
    return @"GrowingTKUIMonitorPlugin";
}
...
#pragma mark - GrowingAPMUIMonitorDelegate
